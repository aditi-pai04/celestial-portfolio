...
const mandalaWorks = [
  {
    ...
    desc: "Hand-drawn Symmetry",
    image: "intricate.jpeg",
  },
  { title: "Solar Core", desc: "Ink & Precision", image: "waves.jpeg" },
  {
    title: "Stardust Pattern",
    desc: "Meditative Geometry",
    image: "durga.jpeg",
  },
      ...
      <div className="dark:hidden">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4">
          {skills.map((skill) => (
            <div
              key={skill}
              className="border border-black p-6 font-body font-bold text-center hover:bg-black hover:text-white transition-all"
            >
              {skill}
            </div>
          ))}
        ...
        <div className="columns-1 md:columns-2 gap-8 space-y-8">
          {mandalaWorks.map((work, i) => (
            ...
            >
              ...
              <p className="font-romantic text-3xl text-accent/80">
                {work.desc}
              </p>
            </motion.div>
          ))}
