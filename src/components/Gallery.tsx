...
const mandalaWorks = [
  { title: "Geometric Flow", desc: "Hand-drawn Symmetry" },
  { title: "Solar Core", desc: "Ink & Precision" },
  { title: "Stardust Pattern", desc: "Meditative Geometry" },
  { title: "The Great Balance", desc: "Complex Mandala" }
];
